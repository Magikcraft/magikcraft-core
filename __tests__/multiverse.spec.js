...
var log = lib_1.log(__filename);
describe('@magikcraft/core/multiverse', function () {
    it('Can import a world', function () { return __awaiter(void 0, void 0, void 0, function () {
        var testWorld, existingWorld, afterImport, noWorld;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    testWorld = 'mct1-start';
                    __1.multiverse.unloadWorld(testWorld); // unload from memory
                    return [4 /*yield*/, __1.multiverse.getMVWorld(testWorld)];
                case 1:
                    existingWorld = _a.sent();
                    expect(existingWorld).toBeNull(); // assert that it is not loaded
                    return [4 /*yield*/, __1.multiverse.importWorld(testWorld)];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, __1.multiverse.getMVWorld(testWorld)];
                case 3:
